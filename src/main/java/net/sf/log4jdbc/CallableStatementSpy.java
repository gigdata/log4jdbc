 ...
 * @author Arthur Blake
 */
public class CallableStatementSpy extends PreparedStatementSpy implements
		CallableStatement {
	...
	public Date getDate(int parameterIndex, Calendar cal) throws SQLException {
		...
		try {
			return (Date) reportReturn(methodCall,
					realCallableStatement.getDate(parameterIndex, cal));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Ref getRef(String parameterName) throws SQLException {
		...
		try {
			return (Ref) reportReturn(methodCall,
					realCallableStatement.getRef(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Blob getBlob(int i) throws SQLException {
		...
		try {
			return (Blob) reportReturn(methodCall,
					realCallableStatement.getBlob(i));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Clob getClob(int i) throws SQLException {
		...
		try {
			return (Clob) reportReturn(methodCall,
					realCallableStatement.getClob(i));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public byte[] getBytes(int parameterIndex) throws SQLException {
		...
		try {
			return (byte[]) reportReturn(methodCall,
					realCallableStatement.getBytes(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public int getInt(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getInt(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Time getTime(int parameterIndex) throws SQLException {
		...
		try {
			return (Time) reportReturn(methodCall,
					realCallableStatement.getTime(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Time getTime(int parameterIndex, Calendar cal) throws SQLException {
		...
		try {
			return (Time) reportReturn(methodCall,
					realCallableStatement.getTime(parameterIndex, cal));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public String getString(int parameterIndex) throws SQLException {
		...
		try {
			return (String) reportReturn(methodCall,
					realCallableStatement.getString(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public void registerOutParameter(int parameterIndex, int sqlType)
			throws SQLException {
		String methodCall = "registerOutParameter(" + parameterIndex + ", "
				+ sqlType + ")";
	...
	public void registerOutParameter(int paramIndex, int sqlType,
		...
		String methodCall = "registerOutParameter(" + paramIndex + ", "
				+ sqlType + ", " + typeName + ")";
		argTraceSet(paramIndex, null, "<OUT>");
		try {
			realCallableStatement.registerOutParameter(paramIndex, sqlType,
					typeName);
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
	...
	public byte getByte(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getByte(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public double getDouble(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getDouble(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public float getFloat(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getFloat(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public int getInt(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getInt(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public long getLong(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getLong(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public short getShort(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getShort(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public boolean getBoolean(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getBoolean(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public byte[] getBytes(String parameterName) throws SQLException {
		...
		try {
			return (byte[]) reportReturn(methodCall,
					realCallableStatement.getBytes(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public void registerOutParameter(String parameterName, int sqlType)
			throws SQLException {
		String methodCall = "registerOutParameter(" + parameterName + ", "
				+ sqlType + ")";
		try {
	...
	public boolean getBoolean(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getBoolean(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Timestamp getTimestamp(int parameterIndex) throws SQLException {
		...
		try {
			return (Timestamp) reportReturn(methodCall,
					realCallableStatement.getTimestamp(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public void setCharacterStream(String parameterName, Reader reader,
		...
		String methodCall = "setCharacterStream(" + parameterName + ", "
				+ reader + ", " + length + ")";
		try {
	...
	public Object getObject(String parameterName) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getObject(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Timestamp getTimestamp(int parameterIndex, Calendar cal)
		...
		try {
			return (Timestamp) reportReturn(methodCall,
					realCallableStatement.getTimestamp(parameterIndex, cal));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Time getTime(String parameterName, Calendar cal) throws SQLException {
		...
		try {
			return (Time) reportReturn(methodCall,
					realCallableStatement.getTime(parameterName, cal));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public short getShort(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getShort(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public long getLong(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getLong(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public float getFloat(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getFloat(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Ref getRef(int i) throws SQLException {
		...
		try {
			return (Ref) reportReturn(methodCall,
					realCallableStatement.getRef(i));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public BigDecimal getBigDecimal(int parameterIndex, int scale)
		...
		try {
			return (BigDecimal) reportReturn(methodCall,
					realCallableStatement.getBigDecimal(parameterIndex, scale));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public URL getURL(int parameterIndex) throws SQLException {
		...
		try {
			return (URL) reportReturn(methodCall,
					realCallableStatement.getURL(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public BigDecimal getBigDecimal(int parameterIndex) throws SQLException {
		...
		try {
			return (BigDecimal) reportReturn(methodCall,
					realCallableStatement.getBigDecimal(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public byte getByte(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getByte(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Object getObject(int parameterIndex) throws SQLException {
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getObject(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public String getString(String parameterName) throws SQLException {
		...
		try {
			return (String) reportReturn(methodCall,
					realCallableStatement.getString(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public BigDecimal getBigDecimal(String parameterName) throws SQLException {
		...
		try {
			return (BigDecimal) reportReturn(methodCall,
					realCallableStatement.getBigDecimal(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Object getObject(String parameterName, Map<String, Class<?>> map)
		...
		try {
			return reportReturn(methodCall,
					realCallableStatement.getObject(parameterName, map));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public URL getURL(String parameterName) throws SQLException {
		...
		try {
			return (URL) reportReturn(methodCall,
					realCallableStatement.getURL(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public RowId getRowId(int parameterIndex) throws SQLException {
		...
		try {
			return (RowId) reportReturn(methodCall,
					realCallableStatement.getRowId(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public RowId getRowId(String parameterName) throws SQLException {
		...
		try {
			return (RowId) reportReturn(methodCall,
					realCallableStatement.getRowId(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public void setNCharacterStream(String parameterName, Reader reader,
		...
		String methodCall = "setNCharacterStream(" + parameterName + ", "
				+ reader + ", " + length + ")";
		try {
	...
	public NClob getNClob(int parameterIndex) throws SQLException {
		...
		try {
			return (NClob) reportReturn(methodCall,
					realCallableStatement.getNClob(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public NClob getNClob(String parameterName) throws SQLException {
		...
		try {
			return (NClob) reportReturn(methodCall,
					realCallableStatement.getNClob(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public SQLXML getSQLXML(int parameterIndex) throws SQLException {
		...
		try {
			return (SQLXML) reportReturn(methodCall,
					realCallableStatement.getSQLXML(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public SQLXML getSQLXML(String parameterName) throws SQLException {
		...
		try {
			return (SQLXML) reportReturn(methodCall,
					realCallableStatement.getSQLXML(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public String getNString(int parameterIndex) throws SQLException {
		...
		try {
			return (String) reportReturn(methodCall,
					realCallableStatement.getNString(parameterIndex));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public String getNString(String parameterName) throws SQLException {
		...
		try {
			return (String) reportReturn(methodCall,
					realCallableStatement.getNString(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Array getArray(String parameterName) throws SQLException {
		...
		try {
			return (Array) reportReturn(methodCall,
					realCallableStatement.getArray(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Blob getBlob(String parameterName) throws SQLException {
		...
		try {
			return (Blob) reportReturn(methodCall,
					realCallableStatement.getBlob(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Clob getClob(String parameterName) throws SQLException {
		...
		try {
			return (Clob) reportReturn(methodCall,
					realCallableStatement.getClob(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public Date getDate(String parameterName) throws SQLException {
		...
		try {
			return (Date) reportReturn(methodCall,
					realCallableStatement.getDate(parameterName));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public <T> T unwrap(Class<T> iface) throws SQLException {
		...
		try {
			...
			// NOTE: could call super.isWrapperFor to simplify this logic, but
			// it would result in extra log output
			// because the super classes would be invoked, thus executing their
			// logging methods too...
			return (T) reportReturn(
					methodCall,
					(iface != null && (iface == CallableStatement.class
							|| iface == PreparedStatement.class
							|| iface == Statement.class || iface == Spy.class)) ? (T) this
